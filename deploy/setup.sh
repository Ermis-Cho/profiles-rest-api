...
# uwsgi: Python daemon for running Python code as a webserver
...
supervisorctl reread # to update the supervisor configuration files
supervisorctl update # to update all the processes
supervisorctl restart profiles_api # to make sure our service is started

# Setup nginx to make our application accessible (serves static files).
